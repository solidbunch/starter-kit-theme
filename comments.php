		...
		<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
			...
			<div class="comment-body">
				...
				<div class="comment-text">
					...
					<?php comment_reply_link( array_merge( $args, array( 'add_below' => 'comment', 'reply_text' => esc_html__('Reply', 'fruitfulblanktextdomain'), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ), get_comment_ID(), get_the_ID() ); ?>
