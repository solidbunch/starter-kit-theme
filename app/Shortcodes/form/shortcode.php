...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_shortcode_contact_form extends WPBakeryShortCodesContainer {	
		...
		protected function content( $atts, $content = null ) {
			...
			return Starter_Kit()->View->load( '/view/view', $data, true, dirname( __FILE__ ) );
		...
		public function enqueue_scripts() {
			...
			/** scripts **/
			wp_register_script( 'shortcode-contact-form', \StarterKit\Helper\Utils::get_shortcodes_uri( basename( dirname( __FILE__ ) ) ) . 'assets/form-scripts.js',array( 'jquery' ), Starter_Kit()->config['cache_time'] );
			...
			/** styles **/
			wp_enqueue_style( 'shortcode-contact-form', \StarterKit\Helper\Utils::get_shortcodes_uri( basename( dirname( __FILE__ ) ) ) . 'assets/style.css', false, Starter_Kit()->config['cache_time'] );
		}
