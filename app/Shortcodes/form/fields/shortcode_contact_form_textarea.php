...
vc_map(array(
	...
	'icon'        => Starter_Kit()->config['shortcodes_icon_uri'] . 'font.svg',
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_shortcode_Contact_Form_Textarea extends WPBakeryShortCode{
		...
		protected function content( $atts, $content = null ){		
			...
			return Starter_Kit()->View->load( '/../view/contact_form_textarea', $data, true, dirname( __FILE__ ) );
		}		
	}
}
