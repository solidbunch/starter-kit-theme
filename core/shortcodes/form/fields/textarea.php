...
vc_map(array(
	'name' => esc_html__('Form Textarea', 'bvc'),
	'base' => 'bvc_contact_form_textarea',
...
if (class_exists('WPBakeryShortCode')) {
	class WPBakeryShortCode_bvc_Contact_Form_Textarea extends WPBakeryShortCode
	{
		...
		protected function content($atts, $content = null)
		{
			...
			ob_start();
			require get_template_directory() . '/core/shortcodes/form/view/contact_form_textarea.php';
			return ob_get_clean();
