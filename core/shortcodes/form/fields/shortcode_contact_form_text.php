...
vc_map(array(
	...
	'base'            => 'shortcode_contact_form_text',
	'icon'        => FFBLANK()->config['shortcodes_icon_uri'] . 'text-field.svg',
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_shortcode_Contact_Form_Text extends WPBakeryShortCode{
		...
		{			
			...
			return FFBLANK()->view->load( '/../view/contact_form_text', $data, true, dirname( __FILE__ ) );
