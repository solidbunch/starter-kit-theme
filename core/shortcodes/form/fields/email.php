...
vc_map(array(
	...
	'base' => 'fruitfulblankprefix_contact_form_email',
...
if (class_exists('WPBakeryShortCode')) {
	class WPBakeryShortCode_fruitfulblankprefix_Contact_Form_Email extends WPBakeryShortCode
	{
		...
		protected function content($atts, $content = null)
		{
			...
			ob_start();
			require get_template_directory() . '/core/shortcodes/form/view/contact_form_email.php';
			return ob_get_clean();
