...
<div <?php echo implode( ' ', $atts ); ?>>
	...
	<?php if( $data['query']->have_posts() ): ?>
		...
		<?php if( filter_var( $data['atts']['pagination'], FILTER_VALIDATE_BOOLEAN ) && $data['query']->max_num_pages > 1 ): ?>

			<div class="posts-pagination text-center">
				<a href="javascript:;" class="shortcode-posts-loadmore btn btn-primary"><?php echo $data['atts']['ajax_load_more_button_text']; ?></a>
			</div>
